...
- **v0.4.0** — watch economy: reader cursors, watch-lifetime rule + scheduled-wake package, commit-signal hooks, id-date rule. *v0.4.1: skeleton pin maintenance. v0.4.2 (current): conformed-version pin semantics.*
