...
**Current: v0.6.0, status: draft.** The pattern is internally consistent and operationally complete — it can be adopted today — and has run in production across multiple projects, accumulating the running-instance lessons that shaped v0.2 through v0.5. Corpus-population conventions will keep sharpening as real instances accumulate findings.
