...
1. **Confirm the auditor file carries the comms duties** (the v0.3.0 template skeleton includes them: read-then-arm discipline, first-boot setup, housekeeping).
